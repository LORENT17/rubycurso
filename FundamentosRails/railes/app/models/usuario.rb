class Usuario < ApplicationRecord
        ...
        private
          ...
          # creando un método de instancia personalizado, <em>.self</em> se refiere al objeto Active Record
          def nombre_completo
          "#{self.nombre} #{self.apellido}"
          end
  
          # creando un método de clase personalizado, <em>.self</em> se refiere al modelo Usuario
          def self.promedio_edad
          self.sum(:edad) / self.count
          end
      end
